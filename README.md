...
## Changelog
- **v1**: checkout to the [v1 branch](https://AuthService/tree/v1) <br>
...
- **v2**: checkout to the [v2 branch](https://AuthService/tree/v2) <br>
...
- **v3**: master branch <br>
  ...
  Desc: Introducing Domain package, the details can be seen on this PR [#21](https://AuthService/pull/21)
...
![golang clean architecture](https://AuthService/raw/master/clean-arch.png)
...
$ git clone https://AuthService.git
...
- All libraries listed in [`go.mod`](https://AuthService/blob/master/go.mod) 
